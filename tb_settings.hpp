        ...
        #define __unlimited -99
            kits[] =
            {
                // BLUFOR or ALL factions
                {
                    ...
                    {__ICE_gear_Grenadier, "Grenadier", 4, 1, 0, 3},
                    {__ICE_gear_MG, "MG", 4, 1, 0, 3},
                    {__ICE_gear_Medic, "Medic", 3, 2, 0, 3},
                    {__ICE_gear_CombatEngineer, "Combat Engineer", 7, 1, 0, 3},
                    {__ICE_gear_LightAT, "Light AT", 4, 0, 0, 4},
                    {__ICE_gear_LightAT, "Heavy AT", 4, 0, 0, 4},
                    {__ICE_gear_AA, "Anti-Air", 0, 0, 0, 4},
                    {__ICE_gear_Marksman, "Marksman", 10, 0, 0, 4},
                    {__ICE_gear_Sniper, "Sniper", 16, 0, 0, 2},
                    {__ICE_gear_SL, "Squad Leader", __unlimited, 0},
                    {__ICE_gear_Crewman, "Crewman", __unlimited, 0, 0, 0},
                    {__ICE_gear_Pilot, "Pilot", 0, 0, 0, 3},
                    {__ICE_gear_Diver, "Heavy MG", 10, 0, 0, 3}
                },
				// OPFOR (delete OPFOR array or leave OPFOR array empty, to re-use (copy) BLUFOR array for both sides)
                {
                    ...
                    {__ICE_gear_MG, "MG", 5, 1, 0, 3},
                    {__ICE_gear_Medic, "Medic", 3, 2, 0, 3},
                    {__ICE_gear_CombatEngineer, "Combat Engineer", 7, 2, 0, 3},
