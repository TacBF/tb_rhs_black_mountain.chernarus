class TacBF
{
	class Supply
	{
		...
		staticWeapons[] = {"RHS_MK19_TriPod_WD", "RHS_AGS30_TriPod_MSV", "rhs_SPG9M_MSV", "RHS_M2StaticMG_MiniTripod_D", "RHS_M2StaticMG_D", "rhs_KORD_high_MSV", "rhs_KORD_MSV", "rhsgref_ins_DSHKM", "rhsgref_ins_DSHKM_Mini_TriPod", "RHS_M252_D", "rhs_2b14_82mm_msv", "RHS_TOW_TriPod_D", "rhs_Metis_9k115_2_msv", "RDS_D30_CSAT", "RHS_ZU23_MSV", "RHS_M119_D"};
